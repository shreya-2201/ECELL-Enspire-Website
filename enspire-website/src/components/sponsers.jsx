    ...
    <>
      ...
      <h1 className="text-white text-5xl mt-10 text-center">Previous Sponsers</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-40 m-20 items-center">
            <a href="" className="flex flex-col items-center justify-center rounded overflow-hidden bg-purple-800/50 h-48 shadow-2xl text-2xl text-white icon"><img src={insyst} alt="" className="w-full h-auto md:w-1/2 lg:w-1/3 m-4" />INSYST</a>
            <a href="" className="flex flex-col items-center justify-center rounded overflow-hidden bg-purple-800/50 h-48 shadow-2xl text-2xl text-white icon"><img src={lensfit} alt="" className="w-full h-auto md:w-1/2 lg:w-1/3 m-4"/>LENSFIT</a>
            <a href="" className="flex flex-col items-center justify-center rounded overflow-hidden bg-purple-800/50 h-48 shadow-2xl text-2xl text-white icon"><img src={blogadda} alt="" className="w-full h-auto md:w-1/2 lg:w-1/3 m-4"/>BLOGADDA</a>
            <a href="" className="flex flex-col items-center justify-center rounded overflow-hidden bg-purple-800/50 h-48 shadow-2xl text-2xl text-white icon"><img src={bugsee} alt="" className="w-full h-auto md:w-1/2 lg:w-1/3 m-4"/>BUGSEE</a>
            <a href="" className="flex flex-col items-center justify-center rounded overflow-hidden bg-purple-800/50 h-48 shadow-2xl text-2xl text-white icon"><img src={ohcampus} alt="" className="w-full h-auto md:w-1/2 lg:w-1/3 m-4"/>OHCAMPUS</a>
            <a href="" className="flex flex-col items-center justify-center rounded overflow-hidden bg-purple-800/50 h-48 shadow-2xl text-2xl text-white icon"><img src={cloudsploit} alt="" className="w-full h-auto md:w-1/2 lg:w-1/3 m-4"/>CLOUDSPOILT</a>
            <a href="" className="flex flex-col items-center justify-center rounded overflow-hidden bg-purple-800/50 h-48 shadow-2xl text-2xl text-white icon"><img src={wazirx} alt="" className="w-full h-auto md:w-1/2 lg:w-1/3 m-4"/>WAZIRX</a>
        </div>
